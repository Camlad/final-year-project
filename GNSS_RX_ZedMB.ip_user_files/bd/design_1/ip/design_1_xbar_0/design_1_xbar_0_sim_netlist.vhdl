...
-- Date        : Tue Nov 20 14:19:54 2018
-- Host        : Lenny running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               C:/sandbox/vhdl/ZedMB_frontEndMon/ZedMB_frontEndMon.srcs/sources_1/bd/design_1/ip/design_1_xbar_0/design_1_xbar_0_sim_netlist.vhdl
...
entity design_1_xbar_0_axi_crossbar_v2_1_18_addr_arbiter_sasd is
  port (
    ...
    \gen_axilite.s_axi_bvalid_i_reg_4\ : in STD_LOGIC;
...
architecture STRUCTURE of design_1_xbar_0_axi_crossbar_v2_1_18_addr_arbiter_sasd is
  ...
  attribute SOFT_HLUTNM of \gen_arbiter.m_amesg_i[27]_i_2\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \m_atarget_hot[8]_i_12\ : label is "soft_lutpair7";
...
architecture STRUCTURE of design_1_xbar_0_axi_crossbar_v2_1_18_splitter is
  ...
  attribute SOFT_HLUTNM of \s_axi_bresp[0]_INST_0_i_3\ : label is "soft_lutpair79";
begin
...
architecture STRUCTURE of \design_1_xbar_0_axi_crossbar_v2_1_18_splitter__parameterized0\ is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \s_axi_bresp[1]_INST_0_i_1\ : label is "soft_lutpair78";
  attribute SOFT_HLUTNM of \s_axi_bresp[1]_INST_0_i_5\ : label is "soft_lutpair78";
begin
...
architecture STRUCTURE of design_1_xbar_0_axi_register_slice_v2_1_17_axic_register_slice is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \gen_arbiter.m_grant_hot_i[1]_i_5\ : label is "soft_lutpair55";
  ...
  attribute SOFT_HLUTNM of \s_axi_bresp[0]_INST_0_i_6\ : label is "soft_lutpair54";
  ...
  attribute SOFT_HLUTNM of \skid_buffer[12]_i_5\ : label is "soft_lutpair54";
  attribute SOFT_HLUTNM of \skid_buffer[31]_i_4\ : label is "soft_lutpair52";
  attribute SOFT_HLUTNM of \skid_buffer[34]_i_6\ : label is "soft_lutpair53";
begin
  Q(34 downto 0) <= \^q\(34 downto 0);
  aa_rready <= \^aa_rready\;
...
addr_arbiter_inst: entity work.design_1_xbar_0_axi_crossbar_v2_1_18_addr_arbiter_sasd
     port map (
      ...
      any_error => any_error,
      aresetn_d => aresetn_d,
      \gen_arbiter.any_grant_reg_0\ => addr_arbiter_inst_n_94,
      \gen_arbiter.any_grant_reg_1\ => addr_arbiter_inst_n_95,
      ...
      \gen_axilite.s_axi_bvalid_i_reg_4\ => \gen_decerr.decerr_slave_inst_n_7\,
...
reg_slice_r: entity work.design_1_xbar_0_axi_register_slice_v2_1_17_axic_register_slice
     port map (
      ...
      aa_rready => aa_rready,
      aclk => aclk,
      \gen_arbiter.m_valid_i_reg\ => addr_arbiter_inst_n_91,
      ...
      \skid_buffer_reg[3]_2\ => reg_slice_r_n_40,
      sr_rvalid => sr_rvalid
    );
...
splitter_aw: entity work.design_1_xbar_0_axi_crossbar_v2_1_18_splitter
     port map (
      ...
      \m_ready_d_reg[0]_7\ => splitter_aw_n_15,
      \m_ready_d_reg[0]_8\ => splitter_aw_n_16,
      ...
      \m_ready_d_reg[2]_4\ => addr_arbiter_inst_n_81,
      mi_wready(0) => mi_wready(8)
    );
end STRUCTURE;
library IEEE;
...
entity design_1_xbar_0_axi_crossbar_v2_1_18_axi_crossbar is
  ...
  attribute C_M_AXI_ADDR_WIDTH of design_1_xbar_0_axi_crossbar_v2_1_18_axi_crossbar : entity is "256'";
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of design_1_xbar_0_axi_crossbar_v2_1_18_axi_crossbar : entity is "512'";
...
architecture STRUCTURE of design_1_xbar_0 is
  ...
  attribute C_M_AXI_ADDR_WIDTH : string;
  attribute C_M_AXI_ADDR_WIDTH of inst : label is "256'";
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of inst : label is "512'";
  attribute C_M_AXI_READ_CONNECTIVITY : string;
